  ...
  return (
    <div className='flex justify-between p-8 m-4 text-gray-300'>
      ...
      <div className='flex flex-col'>
        <div className='flex justify-center'>
          <div className={`${stepNo} ${currStep >= 2 ? `bg-slate-800` : `bg-slate-100`}`}>2</div>
        </div>
      ...
      <div className='flex flex-col'>
        <div className='flex justify-center'>
          <div className={`${stepNo} ${currStep >= 4 ? `bg-slate-800` : `bg-slate-100`}`}>4</div>
        </div>
      ...
      <div className='flex flex-col'>
        <div className='flex justify-center'>
          <div className={`${stepNo} ${currStep === 5 ? `bg-slate-800` : `bg-slate-100`}`}>5</div>
        </div>
