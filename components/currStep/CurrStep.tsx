  ...
  return (
    <div className='flex justify-between p-8 m-4 text-gray-300'>
      <div className='flex flex-col mr-2'>
        ...
        <div className={`text-center p-1 bg-slate-800 rounded-full w-8 text-white`}>1</div>
        </div>
      ...
      <div className='flex flex-col'>
        <div className='flex justify-center'>
        <div className={`${stepNo} ${currStep >= 2 ? `bg-slate-800` : `bg-slate-300`}`}>2</div>
        </div>
      ...
      <div className='flex flex-col mx-2'>
        <div className='flex justify-center'>
            <div className={`${stepNo} ${currStep >= 3 ? `bg-slate-800` : `bg-slate-100`}`}>3</div>
        </div>
      ...
      <div className='flex flex-col'>
      <div className='flex justify-center'>
        <div className={`${stepNo} ${currStep >= 4 ? `bg-slate-800` : `bg-slate-300`}`}>4</div>
      </div>
      ...
      <div className='flex flex-col'>
        <div className='flex justify-center'>
        <div className={`${stepNo} ${currStep === 5 ? `bg-slate-800` : `bg-slate-300`}`}>5</div>
        </div>
